...
window.REGALOS = [
  ...
  { id: "casa-bn-azul",     categoria: "casa", nombre: "Azulejos del baño nuevo",              desc: "Elegidos tras cuatro visitas a la tienda y una pelea amistosa entre mate y brillo. Ganó el mate.", precio: 340, img: "" },
  { id: "casa-bn-puerta",   categoria: "casa", nombre: "La puerta del baño nuevo",             desc: "Pequeña, discreta y capaz de cerrarse cuando toca. Tres virtudes.", precio: 220, img: "" },
  ...
  { id: "casa-coc-campana", categoria: "casa", nombre: "Campana extractora",                   desc: "Imprescindible si queremos que la casa no huela a ajo durante tres días seguidos.", precio: 240, img: "" },
  { id: "casa-coc-horno",   categoria: "casa", nombre: "Horno",                                desc: "El reto de la temporada: conseguir que Salva aprenda a usarlo más allá del modo pizza.", precio: 320, img: "" },
  { id: "casa-coc-nev",     categoria: "casa", nombre: "Nevera",                               desc: "La gran protagonista de las dos de la madrugada. Que sea silenciosa y tenga sitio para el queso.", precio: 340, img: "" },
  { id: "casa-coc-lav",     categoria: "casa", nombre: "Lavavajillas",                         desc: "El mejor regalo que podemos hacernos en pareja. Un árbitro silencioso en la cocina.", precio: 320, img: "" },
  { id: "casa-coc-azul",    categoria: "casa", nombre: "Azulejos y frontal",                   desc: "El trozo de pared entre la encimera y los armarios. Pequeño, visible, decisivo.", precio: 280, img: "" },
  { id: "casa-coc-ilum",    categoria: "casa", nombre: "Iluminación de la cocina",             desc: "Focos bajo los muebles. Luz directa donde se corta cebolla. Civilización pura.", precio: 180, img: "" },
  { id: "casa-coc-mano1",   categoria: "casa", nombre: "Mano de obra · cocina I",              desc: "Las horas del fontanero. Pocas palabras, muchas soluciones.", precio: 260, img: "" },
  { id: "casa-coc-mano2",   categoria: "casa", nombre: "Mano de obra · cocina II",             desc: "Las horas del electricista. Con los cables que nunca están donde deberían.", precio: 260, img: "" },

  // ——— Baño entero reformado (4500 €) ———
  { id: "casa-b2-plato",    categoria: "casa", nombre: "Plato de ducha",                       desc: "Adiós a la bañera imposible de limpiar. Hola a la ducha a ras de suelo y a las piernas sin calambres.", precio: 320, img: "" },
  { id: "casa-b2-mampara",  categoria: "casa", nombre: "Mampara de la ducha",                  desc: "La que decide si el suelo acaba mojado o no. Una responsabilidad enorme para un cristal.", precio: 280, img: "" },
  { id: "casa-b2-wc",       categoria: "casa", nombre: "Inodoro del baño principal",           desc: "Suspendido. Parece que flota. En realidad está mejor anclado que nuestras vidas.", precio: 260, img: "" },
  { id: "casa-b2-mueb",     categoria: "casa", nombre: "Mueble y lavabo doble",                desc: "Sí, doble. Porque por las mañanas hay prisa y paciencia en cantidades distintas.", precio: 340, img: "" },
  { id: "casa-b2-grif",     categoria: "casa", nombre: "Grifería y termostática",              desc: "La ducha con termostato, para que la temperatura no cambie cuando alguien abre un grifo en la cocina.", precio: 220, img: "" },
  { id: "casa-b2-azul1",    categoria: "casa", nombre: "Azulejos del baño · parte I",          desc: "La pared de detrás del lavabo. La que se ve en todas las fotos de espejo del móvil.", precio: 320, img: "" },
  { id: "casa-b2-azul2",    categoria: "casa", nombre: "Azulejos del baño · parte II",         desc: "La pared de la ducha. Esa que hay que limpiar con ganas una vez al mes.", precio: 320, img: "" },
  { id: "casa-b2-suelo",    categoria: "casa", nombre: "Suelo del baño",                       desc: "Antideslizante, porque nadie quiere que una ducha termine en urgencias.", precio: 240, img: "" },
  { id: "casa-b2-esp",      categoria: "casa", nombre: "Espejo retroiluminado",                desc: "Con lucecita detrás. Queda de revista. Es el tipo de capricho que no te arrepientes de tener.", precio: 220, img: "" },
  { id: "casa-b2-mano",     categoria: "casa", nombre: "Mano de obra · baño principal",        desc: "Dos semanas de obras, de escombros en el pasillo y de 'mañana ya termino'. Pagar por ello es justicia.", precio: 340, img: "" },

  // ——— Pintar las paredes (1000 €) ———
  { id: "casa-pint-1",      categoria: "casa", nombre: "Pintura · salón y pasillo",            desc: "Un blanco con algo de ropa tendida. Nada dramático. Solo que respire la luz.", precio: 280, img: "" },
  { id: "casa-pint-2",      categoria: "casa", nombre: "Pintura · dormitorio",                 desc: "Un tono tierra muy suave, de esos que relajan sin que te des cuenta. Test de almohada aprobado.", precio: 260, img: "" },
  { id: "casa-pint-3",      categoria: "casa", nombre: "Pintura · cocina y baños",             desc: "Pintura plástica, lavable, preparada para salpicaduras y vaporcillos.", precio: 220, img: "" },
  { id: "casa-pint-4",      categoria: "casa", nombre: "Mano de obra del pintor",              desc: "El hombre del rodillo. Llega, tapa muebles, pinta, se va y todo huele a nuevo durante tres días.", precio: 240, img: "" },

  // ——— Tarima flotante (1000 €) ———
  { id: "casa-tar-1",       categoria: "casa", nombre: "Tarima · salón",                       desc: "Suelo nuevo que suena a hogar nuevo. Nos acostumbraremos en tres días a no llevar zapatos.", precio: 340, img: "" },
  { id: "casa-tar-2",       categoria: "casa", nombre: "Tarima · dormitorio",                  desc: "Caliente al pie, silencioso en las sobremesas. Y con un dibujo que imita una madera bonita.", precio: 320, img: "" },
  { id: "casa-tar-3",       categoria: "casa", nombre: "Rodapié y colocación",                 desc: "Ese detallito que separa un suelo de un suelo bien puesto. Lo notarás o no, pero está ahí.", precio: 340, img: "" },

  // ——— Muebles pendientes ———
  { id: "casa-cama-1",      categoria: "casa", nombre: "La cama · estructura",                 desc: "Literalmente el mueble más usado de nuestra vida. Lo justo es pagar por él a plazos generacionales.", precio: 260, img: "" },
  { id: "casa-cama-2",      categoria: "casa", nombre: "La cama · cabecero",                   desc: "Tapizado, para leer sin clavarse la pared. Obligatorio en toda casa que se precie.", precio: 220, img: "" },
  ...
  { id: "casa-mesillas",    categoria: "casa", nombre: "Mesillas de noche (pareja)",           desc: "Dos iguales, para evitar conflictos territoriales. Cada una con su lámpara y su libro empezado.", precio: 240, img: "" },
  { id: "casa-sofa-1",      categoria: "casa", nombre: "Sofá · armazón",                       desc: "La estructura del protagonista del salón. De él dependen siestas, series y visitas.", precio: 320, img: "" },
  { id: "casa-sofa-2",      categoria: "casa", nombre: "Sofá · chaise longue",                 desc: "El rincón para estirar las piernas. Negociable. Lo negociaremos contigo si lo reservas.", precio: 280, img: "" },
  { id: "casa-mesasalon",   categoria: "casa", nombre: "Mesa de centro del salón",             desc: "Donde aterrizarán tés, mandos, llaves, revistas, cacahuetes y, algún domingo, los pies.", precio: 200, img: "" },
  { id: "casa-mesacom-1",   categoria: "casa", nombre: "Mesa de comedor",                      desc: "De madera noble, de esa que envejece bien con manchas de vino y sobremesas largas.", precio: 340, img: "" },
  { id: "casa-sillas-1",    categoria: "casa", nombre: "Sillas de comedor · parte I",          desc: "Tres sillas. Las del lado de Lorena, donde se habla más y se come más despacio.", precio: 200, img: "" },
  { id: "casa-sillas-2",    categoria: "casa", nombre: "Sillas de comedor · parte II",         desc: "Otras tres. Las del lado de Salva, donde la copa se vacía antes.", precio: 200, img: "" },
  { id: "casa-lampsalon",   categoria: "casa", nombre: "Lámpara de techo del salón",           desc: "La que dará luz a nuestras cenas, a los partidos importantes y a las discusiones sobre qué peli ver.", precio: 220, img: "" },
  { id: "casa-lampcom",     categoria: "casa", nombre: "Lámpara de techo del comedor",         desc: "Baja, sobre la mesa. De esas que dibujan sombras bonitas y hacen que la cena parezca otra cosa.", precio: 200, img: "" },
  { id: "casa-ventilador1", categoria: "casa", nombre: "Ventilador de techo · salón",          desc: "Porque un agosto en el Mediterráneo sin aspas girando es un castigo innecesario.", precio: 180, img: "" },
  { id: "casa-ventilador2", categoria: "casa", nombre: "Ventilador de techo · dormitorio",     desc: "Con mando. Para no tener que levantarse. Es esa clase de regalo que se usa todas las noches de julio a septiembre.", precio: 180, img: "" },
