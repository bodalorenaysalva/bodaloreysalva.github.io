...
window.REGALOS = [
  ...
  { id: "casa-b2-grif",     categoria: "casa", nombre: "Grifería y termostática",              desc: "La ducha con termostato, para que la temperatura no cambie cuando alguien abre un grifo en la cocina.", precio: 220, img: "img/platodeducha.jpg" },
  { id: "casa-b2-azul1",    categoria: "casa", nombre: "Azulejos del baño · parte I",          desc: "La pared de detrás del lavabo. La que se ve en todas las fotos de espejo del móvil.", precio: 320, img: "img/platodeducha.jpg" },
  { id: "casa-b2-azul2",    categoria: "casa", nombre: "Azulejos del baño · parte II",         desc: "La pared de la ducha. Esa que hay que limpiar con ganas una vez al mes.", precio: 320, img: "img/platodeducha.jpg" },
  { id: "casa-b2-suelo",    categoria: "casa", nombre: "Suelo del baño",                       desc: "Antideslizante, porque nadie quiere que una ducha termine en urgencias.", precio: 240, img: "img/platodeducha.jpg" },
  { id: "casa-b2-esp",      categoria: "casa", nombre: "Espejo retroiluminado",                desc: "Con lucecita detrás. Queda de revista. Es el tipo de capricho que no te arrepientes de tener.", precio: 220, img: "img/platodeducha.jpg" },
  { id: "casa-b2-mano",     categoria: "casa", nombre: "Mano de obra · baño principal",        desc: "Dos semanas de obras, de escombros en el pasillo y de 'mañana ya termino'. Pagar por ello es justicia.", precio: 340, img: "img/platodeducha.jpg" },
